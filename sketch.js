...
function drawBeatboxPage() {
  ...
  image(bbox, 500, 100);
  // image(beatk,500,100);
// Set opacity for the music image
// tint(255, 150); // 150 is the alpha value (opacity), ranges from 0 (transparent) to 255 (opaque)
// image(music, 50, 50);


// Reset tint to default for subsequent drawings
//noTint();
}
